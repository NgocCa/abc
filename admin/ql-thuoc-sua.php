        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Thêm thông tin thuốc mới</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="ma_thuoc" class="col-sm-3 control-label">Mã thuốc</label>
                        <div class="col-sm-9">
                            <input name="ma_thuoc" type="text" value="" class="form-control" id="name" placeholder="Nhập mã thuốc" required=""/>
                        </div>
                    </div>     
                    <div class="form-group">
